...
output "load_balancer_controller_role_arn" {
  ...
  value       = var.aws_academy || !var.manage_iam ? null : (var.load_balancer_controller_role_arn != "" ? var.load_balancer_controller_role_arn : aws_iam_role.load_balancer_controller[0].arn)
}
