...
- Output values are passed via Terraform remote state data source or
  manual variable injection in CI — mechanism TBD when the state backend
  is provisioned for real.
